---
title: 'Root Rot in Houseplants: How to Identify and Save Your Plant'
...
causes:
  ...
  - name: 'No drainage holes'
    ...
    fix: 'Move the plant into a pot with drainage holes. If you love the decorative pot, keep the plant in a plastic nursery pot inside it and lift it out to water.'
  - name: 'Soil too dense'
    likelihood: 'common'
  ...
  - name: 'Cold plus wet'
    ...
    fix: 'Cut watering back sharply in winter and move the plant off cold surfaces.'
  - name: 'Fungal or bacterial infection'
    likelihood: 'rare'
    tell: 'Rot spreading fast despite correct watering, often after using unsterilised reused soil or tools.'
    fix: 'Remove all affected tissue, repot into fresh sterile mix, and sterilise tools between cuts with rubbing alcohol.'
affectedPlants:
  - snake-plant
  - zz-plant
  - aloe-vera
...
3. The plant wilts despite the soil being wet
4. Stem or leaf bases feel soft or squashy at the soil line
...
| | Healthy | Rotted |
| --- | --- | --- |
| Colour | White, cream, pale tan | Brown, grey or black |
| Texture | Firm, springy | Soft, slimy, mushy |
| When tugged | Resists or snaps | Outer layer slides off, leaving a thread |
| Smell | Clean and earthy | Sour, swampy, sewage-like |

Firmness is the reliable test. Some species naturally have darker roots, so colour alone can mislead.
