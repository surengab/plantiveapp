...
causes:
  ...
  - name: 'Root rot from overwatering'
    likelihood: 'common'
    tell: 'Soil damp or wet, yet the plant is still wilting. Stem base may be soft; the soil may smell sour. Watering makes it worse.'
    fix: 'Unpot, trim every soft brown root, repot into fresh dry well-draining mix and hold off watering for a week.'
  - name: 'Transplant shock'
    likelihood: 'common'
    tell: 'Drooping started within days of repotting or dividing. Roots were disturbed and cannot yet supply the foliage.'
    fix: 'Keep conditions stable, out of direct sun, and water lightly. Most plants recover in one to three weeks. Do not repot again.'
  ...
  - name: 'Root-bound'
    ...
    fix: 'Repot one size up in spring, teasing the circling roots loose before settling it into fresh mix.'
  - name: 'Pest damage to roots or stems'
    likelihood: 'rare'
    tell: 'Wilting with no watering explanation. Look for grubs in the soil, or soft chewed areas at the stem base.'
    fix: 'Unpot and inspect the root ball. Rinse the roots clean, remove any larvae, and repot into fresh sterile mix.'
affectedPlants:
  - peace-lily
  - pothos
  - calathea
...
faqs:
  ...
  - question: 'Why is my plant drooping after repotting?'
    answer: 'Transplant shock. Repotting inevitably breaks some of the fine root hairs that do most of the water absorption, so for a while the roots cannot keep up with what the leaves lose. Keep the plant out of direct sun, maintain stable conditions, water lightly, and resist the urge to intervene further. Most plants recover within one to three weeks.'
  - question: 'Is it bad to let a plant wilt before watering?'
    answer: 'It is not ideal, though some plants tolerate it. Peace lilies and pothos wilt dramatically and recover completely, and many people use that as their watering cue. But repeated severe wilting damages fine root hairs and causes permanent brown leaf edges. Better to water just before that point, when the soil is dry at the depth that species prefers.'
featured: false
---
...
- **Dry** → thirst. Water thoroughly. It should recover within a few hours.
- **Damp or wet** → do not water. The problem is roots, and adding water makes it worse.

That is the whole diagnosis for most cases, and it takes ten seconds.

## Why wet soil causes wilting
...
A plant next to a radiator loses water from its leaves faster than roots can supply it. A plant in a cold draft has roots too chilled to take up water efficiently. Both look like wilting.
...
If a plant needs water every day or two, water runs straight through the pot in seconds, and roots are visible circling out of the drainage holes, there is barely any soil left to hold moisture.

**What to do:** repot one size up in spring. Tease the circling roots loose before settling the plant into fresh mix, or they keep growing in a spiral.
...
The response to watering tells you whether you diagnosed correctly:
