...
keywords:
  ...
  - why no holes in monstera leaves
...
causes:
  ...
  - name: 'The plant is still juvenile'
    ...
    fix: 'Wait. Monsteras produce solid juvenile leaves for their first year or two regardless of care. Good light speeds the transition considerably.'
  - name: 'Nothing to climb'
    likelihood: 'common'
    tell: 'The plant sprawls sideways out of the pot rather than growing upward. Aerial roots hang loose with nothing to attach to.'
    fix: 'Add a moss pole, coir pole or wooden plank. Climbing triggers the mature growth pattern, producing bigger and more fenestrated leaves.'
  - name: 'Root-bound or starved'
    likelihood: 'less common'
    tell: 'Same pot for three or more years, roots circling the drainage holes, new leaves noticeably smaller than old ones.'
    fix: 'Repot one size up in spring into a chunky aroid mix, and feed monthly at half strength through the growing season.'
  - name: 'Wrong species'
    likelihood: 'less common'
    tell: 'Leaves stay small, thin and heart-shaped, and the plant trails rather than climbs.'
    fix: 'Check the identification. Many plants sold as "mini monstera" are Rhaphidophora tetrasperma, and some small trailing plants are philodendrons that never fenestrate.'
affectedPlants:
  - monstera-deliciosa
faqs:
...
The holes and splits are called **fenestrations**, from the Latin for window. The leading explanation is that they let light through to leaves lower down the plant, and let strong winds and heavy rain pass through a large leaf without tearing it.

Two things matter for our purposes:

1. **Each leaf's pattern is set before it unfurls.** A solid leaf will never develop holes later.
2. **Fenestration is a mature growth trait.** The plant has to be ready.

That means you judge any fix by the *new* leaves, not the old ones.

## Cause 1: not enough light

The most common reason by a distance. Producing large fenestrated leaves is energetically expensive, and a plant in dim light simply cannot afford it.
...
## Cause 2: it is still young

Monsteras go through a juvenile phase producing solid, heart-shaped leaves that look nothing like the plant you imagined buying. This is completely normal and lasts one to three years.
...
**How to tell:** the plant grows outward rather than upward, and its aerial roots hang loose with nothing to grip.
...
Aerial roots attach within a few weeks, and the difference in leaf size within one season is usually obvious.

## Cause 4: root-bound or underfed

A plant that has run out of root space and nutrients cannot support large leaves.
...
With good light, a moss pole and regular feeding, a healthy young monstera typically starts splitting within a season or two. Interior holes come later still, on a plant that has been fenestrating reliably for a while.

The full care routine is in the [Monstera deliciosa care guide](/plant-care/monstera-deliciosa/).
