---
title: 'Spider Mites on Houseplants: How to Spot and Kill Them'
description: 'Spider mites are almost invisible until the webbing appears. How to confirm them with the paper test, and the three-week treatment that breaks their life cycle.'
heading: 'Spider Mites: Spot Them and Kill Them'
...
causes:
  - name: 'Hot, dry air'
    ...
    tell: 'Outbreak began in winter with heating on, or near a radiator or sunny window. Mites reproduce fastest in warm dry conditions.'
    fix: 'Raise humidity above 50% and move the plant away from heat sources. Mites struggle in humid air.'
  - name: 'A newly introduced plant'
    likelihood: 'common'
    tell: 'Symptoms appeared within a few weeks of bringing home a new plant or bringing plants in from outside.'
    fix: 'Quarantine every new plant for two to three weeks, inspecting leaf undersides weekly before adding it to your collection.'
  - name: 'Dusty, unwashed foliage'
    likelihood: 'common'
    tell: 'Leaves are visibly dusty. Mites shelter in dust and are harder to dislodge.'
    fix: 'Wipe leaves monthly with a damp cloth and shower plants in the sink a few times a year.'
  - name: 'Overcrowded plants with poor airflow'
    likelihood: 'less common'
    tell: 'Plants packed closely together; the infestation spreads from one to its neighbours within days.'
    fix: 'Space plants so leaves do not touch, and improve ventilation.'
affectedPlants:
  - calathea
  - monstera-deliciosa
  - fiddle-leaf-fig
...
**The stippling.** Look at the top surface of affected leaves. Spider mites feed by piercing individual cells and draining them, leaving a scatter of tiny pale dots. Early on it looks like fine dust or a faint speckling; later the whole leaf goes bronze or greyish and dull.
...
Three weeks, no shortcuts. The reason infestations come back is almost always stopping early.

### Step 1: physical removal

Take the plant to a shower or sink and **rinse it thoroughly**, paying particular attention to leaf undersides and joints. Lukewarm water, moderate pressure. This removes the bulk of the adult population immediately and is the highest-value single action you can take.

For a large plant, wipe every leaf on both sides with a damp cloth.

### Step 2: spray, every five days for three weeks
...
Spider mites explode in **hot, dry air**, which is exactly what a heated home in winter provides.
...
- **Misting alone.** Helps prevent, does not cure.
- **A single spray.** Kills the adults you hit and nothing else. The eggs hatch a week later and you are back where you started.
- **Systemic granules for indoor plants.** Overkill for most homes, and many are not labelled for indoor use.

## Preventing the next one

- **Quarantine new plants for two to three weeks**, checking undersides weekly. This is where most infestations come from.
- **Inspect when you water.** Turn over two or three leaves each time. Thirty seconds a week catches problems while they are small.
