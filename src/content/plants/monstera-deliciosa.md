...
difficulty: easy
petSafe: false
matureSize: '6–8 ft tall indoors, 3 ft wide; leaves up to 2 ft across'
growthRate: fast
...
troubleshooting:
  ...
  - symptom: 'Lower leaves turning yellow, soil stays damp'
    ...
    fix: 'Let the top 2 inches dry fully before the next water and repot into a chunky aroid mix with more bark and perlite.'
  ...
  - symptom: 'Long bare stems with widely spaced small leaves'
    ...
    fix: 'Move it closer to the light and give it a moss pole to climb — climbing monsteras produce larger, more fenestrated leaves.'
    problemSlug: 'leggy-stretched-houseplants'
faqs:
  - question: 'How often should I water a Monstera deliciosa?'
    answer: 'Water when the top 2 inches of soil feel dry, which is usually every 7–14 days in spring and summer and every 2–3 weeks in winter. Frequency depends on pot size, light and season far more than on a fixed schedule — always check the soil rather than watering by calendar.'
  ...
  - question: 'Should I cut the aerial roots off my Monstera?'
    answer: 'No, leave them. Aerial roots anchor the plant to its support and absorb moisture, and removing them stresses the plant. Either tuck them into a moss pole, direct them back into the pot, or simply let them hang.'
  - question: 'How do I make my Monstera grow bigger leaves?'
    answer: 'Give it something to climb. In the wild Monsteras are hemiepiphytes that grow larger leaves the higher they climb. A moss pole or wooden plank, combined with bright indirect light and monthly feeding through the growing season, produces noticeably bigger and more fenestrated foliage.'
related:
  - pothos
...
Fenestration — the holes and splits — is the reason most people buy this plant, and it is almost entirely a light story.
...
1. Remove any yellow or damaged leaves at the base of their stem.
2. Cut back leggy stems just above a node to encourage branching.
3. Save the cuttings — anything with a node and an aerial root will root in water.
