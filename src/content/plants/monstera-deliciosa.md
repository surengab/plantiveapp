...
troubleshooting:
  ...
  - symptom: 'Long bare stems with widely spaced small leaves'
    ...
    fix: 'Move it closer to the light and give it a moss pole to climb, because climbing monsteras produce larger, more fenestrated leaves.'
...
3. Save the cuttings, since anything with a node and an aerial root will root in water.
