---
title: 'Snake Plant Care: Watering, Light and Root Rot Prevention'
...
family: 'Asparagaceae'
origin: 'Tropical West Africa, from Nigeria to the Congo'
silhouette: lance
hue: 90
difficulty: easy
petSafe: false
matureSize: '2–4 ft tall, spreading slowly by rhizome'
growthRate: slow
toxicity: 'Contains saponins that cause vomiting, drooling and diarrhoea in cats and dogs if chewed. Rarely serious but unpleasant.'
care:
  light:
  ...
  temperature:
    label: '60–85°F (15–29°C)'
    detail: 'Keep above 50°F (10°C). Cold plus wet soil is the combination that kills snake plants.'
  soil:
...
troubleshooting:
  - symptom: 'Leaves soft, mushy and yellow at the base'
    ...
    fix: 'Unpot immediately, cut away every soft root and rhizome, let the cuts callus for a day, then repot into dry cactus mix. Do not water for a week.'
    problemSlug: 'root-rot'
  - symptom: 'Leaves falling over and splaying outward'
    cause: 'Too little light, or a pot too large and wet'
    fix: 'Move to brighter light and check the soil is drying fully. Very tall leaves may simply need staking or dividing.'
  - symptom: 'Brown crispy tips'
    cause: 'Inconsistent watering or fluoride in tap water'
    fix: 'Water thoroughly but far less often, and switch to filtered or left-out tap water. Trim the brown tip at an angle if it bothers you.'
    problemSlug: 'brown-leaf-tips'
  - symptom: 'Wrinkled, curling leaves'
    cause: 'Severe underwatering — rare, but it happens'
...
faqs:
  ...
  - question: 'Why is my snake plant falling over?'
    answer: 'Usually one of two things. Either the plant is reaching for light and the leaves have grown weak and elongated, or the base has begun to rot from overwatering and can no longer support the leaves. Check the base first — if it is soft or smells sour, treat it as root rot immediately.'
  - question: 'Do snake plants really clean the air?'
    answer: 'They do remove some volatile compounds in sealed laboratory chambers, which is where the famous NASA study was run. In a real room with normal air exchange, the effect is far too small to measure. Grow them because they are handsome and nearly indestructible, not as an air purifier.'
  - question: 'How do I propagate a snake plant and keep the yellow edges?'
    answer: 'Divide it rather than taking leaf cuttings. Variegated types such as Laurentii propagate true only by division, because leaf cuttings grow from the plain green tissue and lose the yellow margins. Tip the plant out, separate the rhizome clumps by hand or with a clean knife, and pot each section separately.'
related:
  - zz-plant
  - aloe-vera
  - spider-plant
...
Snake plants are the standard recommendation for low light, and the recommendation is broadly right — but "tolerates" is not "prefers".

| Light level | What happens |
| --- | --- |
| Bright indirect | Fastest growth, strongest variegation, may flower |
| Medium indirect | Steady, slow growth — the typical indoor result |
| Low | Survives for a long time, grows almost nothing |
...
This is the failure mode, so know the signs:

- Leaves that were rigid become soft and floppy near the soil line
- The base of a leaf turns yellow-brown and squashy
- A sour, boggy smell from the soil
- Leaves pull away from the base with almost no resistance

Act immediately:

1. Tip the plant out and shake off all the old soil.
2. Cut away every root and rhizome section that is brown, soft or stringy. Healthy roots are firm and pale orange.
3. Leave the cut sections exposed to air for 24 hours to callus.
4. Repot into **dry** cactus mix in a clean terracotta pot.
5. Do not water for at least a week.

If the rot has reached most of the rhizome, salvage the healthiest leaves as cuttings and start over.
...
**Leaf cuttings.** Cut a healthy leaf into 3-inch sections, keeping track of which end pointed down — they only root from the original bottom edge. Let the cuts callus for a day or two, then stand them upright in barely damp mix. Roots take 4–8 weeks and pups follow after that.
