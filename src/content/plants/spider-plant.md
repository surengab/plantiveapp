...
alsoKnownAs:
  ...
  - Spider ivy
family: 'Asparagaceae'
origin: 'Coastal southern and western Africa'
silhouette: trailing
hue: 115
difficulty: easy
petSafe: true
...
troubleshooting:
  - symptom: 'Brown, crispy leaf tips'
    ...
    fix: 'Switch to filtered, distilled or stood tap water, feed at half strength, and flush the soil twice a year. This is the classic spider plant complaint.'
    problemSlug: 'brown-leaf-tips'
  - symptom: 'No runners or babies'
    cause: 'Not enough light, plant too young, or pot too large'
    fix: 'Move to bright indirect light. Spider plants produce plantlets when mature and slightly root-bound, so resist over-potting.'
  - symptom: 'Pale, washed-out leaves losing their stripe'
    cause: 'Too much direct sun'
    fix: 'Move out of direct light. Variegation strengthens again in bright but indirect conditions.'
  - symptom: 'Leaves yellowing and base going soft'
    cause: 'Overwatering'
    fix: 'Let the top inch dry between waterings and make sure the pot is not sitting in water.'
    problemSlug: 'yellow-leaves-on-houseplants'
faqs:
  - question: 'Are spider plants safe for cats and dogs?'
    answer: 'Yes. Chlorophytum comosum is listed as non-toxic to cats, dogs and horses. Cats are often drawn to the arching leaves and may chew them, which can cause mild vomiting simply from eating plant material, but there are no toxic compounds involved. It is one of the best choices for a home with pets.'
  - question: 'Why does my spider plant have brown tips?'
    answer: 'Spider plants are unusually sensitive to fluoride and chlorine in tap water, which accumulate at the leaf tips and burn them. Switch to filtered or distilled water, or leave tap water in an open jug overnight. Dry air and over-fertilising cause the same symptom, so feed at half strength and flush the soil with plain water twice a year.'
  - question: 'How do I root spider plant babies?'
    answer: 'The easiest method is to leave the plantlet attached to the mother plant, set a small pot of moist soil next to it, and pin the base of the plantlet onto the surface with a bent paperclip. It roots in two to three weeks while still being fed by the runner, and you then snip the runner. Detached plantlets also root in water or soil, just less reliably.'
...
Spider plants are unusually sensitive to **fluoride**, and to a lesser degree chlorine, both of which are added to most municipal tap water. The plant draws water up to the leaf tips, the water evaporates, and the minerals stay behind and burn the tissue.
...
Dry winter air contributes too. Getting humidity up to around 50% noticeably reduces new tip burn.

Existing brown tips will not turn green again. Trim them with clean scissors at a shallow angle following the leaf's natural taper, which looks far better than a straight cut.
...
Bright indirect light is the target. It gives you:

- The strongest contrast in variegated cultivars like 'Vittatum' and 'Variegatum'
- The most runners and plantlets
- Compact, arching growth rather than floppy stretching

Direct sun bleaches the leaves to a pale, washed-out yellow-green. Medium light is tolerated but produces fewer babies.
...
1. Fill a small pot with moist potting mix and set it next to the mother plant.
2. Lay a plantlet on the surface, still attached to its runner.
3. Pin it down with a bent paperclip or hairpin so the little root nubs touch the soil.
4. Keep the mix lightly moist. Roots establish in two to three weeks.
5. Snip the runner once the plantlet is anchored and pushing new growth.
